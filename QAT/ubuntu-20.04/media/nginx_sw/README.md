...
## Supported tags and respective Dockerfile links
 - [qat-ubuntu-2004-media-nginx_sw](https://github.com/OpenVisualCloud/Dockerfiles/blob/v21.3/QAT/ubuntu-20.04/media/nginx_sw/Dockerfile)

## Quick reference
- #### Supported platform and OS
  Intel&reg; QAT platform, Ubuntu 20.04
