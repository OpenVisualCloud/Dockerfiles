...
## Supported tags and respective Dockerfile links
 - [qat-ubuntu-1604-media-nginx](https://github.com/OpenVisualCloud/Dockerfiles/blob/master/QAT/ubuntu-16.04/media/nginx/Dockerfile)

## Quick reference
- #### Supported platform and OS
Intel&reg; QAT platform, Ubuntu 16.04
