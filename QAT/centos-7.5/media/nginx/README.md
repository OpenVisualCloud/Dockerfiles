...
## Supported tags and respective Dockerfile links
 - [qat-centos-75-media-nginx](https://github.com/OpenVisualCloud/Dockerfiles/blob/master/QAT/centos-7.5/media/nginx/Dockerfile)

## Quick reference
- #### Supported platform and OS
Intel&reg; QAT platform, CentOS-7.5.1804
