...
## Supported tags and respective Dockerfile links
 - [vcac-a-centos-74-analytics-ffmpeg](https://github.com/OpenVisualCloud/Dockerfiles/blob/master/VCAC-A/centos-7.4/analytics/ffmpeg/Dockerfile)

## Quick reference
- #### Supported platform and OS
Intel&reg; VCAC-A platform, CentOS-7.4.1708
