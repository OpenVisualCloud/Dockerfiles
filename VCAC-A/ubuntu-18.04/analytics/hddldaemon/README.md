This docker image is part of Open Visual Cloud software stacks. Optimized for Media Analytics. Optimized OpenVINO HDDL daemon installed and configured. The docker image can be used in the FROM field of a downstream Dockerfile. 
