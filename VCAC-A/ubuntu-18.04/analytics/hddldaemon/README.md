This docker image is part of Open Visual Cloud software stacks. Optimized for Media Analytics. The docker image can be be used in the FROM field of a downstream Dockerfile. 
