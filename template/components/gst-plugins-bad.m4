...
`define(`GSTBAD_BUILD_DEPS',ifdef(`BUILD_MESON',,meson) wget tar gcc-c++ glib2-devel bison flex GST_CURLUSESSL_BUILD GST_RTMP_BUILD GST_MJPEG_BUILD GST_X265ENC_BUILD GST_LIBDE265DEC_BUILD)'
