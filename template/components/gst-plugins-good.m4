...
`define(`GSTGOOD_BUILD_DEPS',git ca-certificates ifdef(`BUILD_MESON',,meson) tar g++ wget pkg-config libglib2.0-dev flex bison GST_XLIB_BUILD GST_GDKPIXBUF_BUILD GST_JPEG_BUILD GST_PNG_BUILD GST_MP4_BUILD GST_SOUP_BUILD GST_VPX_BUILD)'
...
`define(`GSTGOOD_BUILD_DEPS',git ifdef(`BUILD_MESON',,meson) wget tar gcc-c++ glib2-devel bison flex GST_XLIB_BUILD GST_GDKPIXBUF_BUILD GST_JPEG_BUILD GST_PNG_BUILD GST_MP4_BUILD GST_SOUP_BUILD GST_VPX_BUILD)'
