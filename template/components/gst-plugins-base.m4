...
`define(`GSTBASE_BUILD_DEPS',ca-certificates ifdef(`BUILD_MESON',,meson) tar g++ gobjc wget pkg-config libglib2.0-dev flex bison GST_XLIB_BUILD GST_ALSA_BUILD GST_PANGO_BUILD GST_THEORA_BUILD GST_LIBVISUAL_BUILD GST_OPENGL_BUILD)'
...
`define(`GSTBASE_BUILD_DEPS',ifdef(`BUILD_MESON',,meson) wget tar gcc gcc-objc gcc-c++ glib2-devel bison flex GST_XLIB_BUILD GST_ALSA_BUILD GST_PANGO_BUILD GST_THEORA_BUILD GST_LIBVISUAL_BUILD GST_OPENGL_BUILD)'
