...
ifelse(OS_NAME,centos,`
define(`OWT_BUILD_DEPS',`ifdef(`BUILD_OPENSSL',,openssl-devel ) ifdef(`BUILD_GIT',,git) gcc npm python glib2-devel boost-devel log4cxx-devel pkg-config devtoolset-9')
')
