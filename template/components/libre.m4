...
define(`LIBRE_BUILD_DEPS',git cmake make autoconf gcc)
')
...
RUN cd BUILD_HOME && \
    ...
    make SYSROOT_ALT=BUILD_DESTDIR/usr RELEASE=1 && \
    make install SYSROOT_ALT=BUILD_DESTDIR/usr RELEASE=1 PREFIX=BUILD_DESTDIR/usr
')
