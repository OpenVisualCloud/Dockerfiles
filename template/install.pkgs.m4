...
RUN ifdef(`INSTALL_PKGS_FFMPEG',yum install -y epel-release;) \
    yum install -y -q defn(`INSTALL_PKGS_FFMPEG',`INSTALL_PKGS_TRANSFORM360',`INSTALL_PKGS_GST',`INSTALL_PKGS_NGINX',`INSTALL_PKGS_LIBDRM',`INSTALL_PKGS_GST_PLUGIN_VAAPI',`INSTALL_PKGS_GST_PLUGIN_BASE'); \
