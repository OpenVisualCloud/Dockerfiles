...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y -q --no-install-recommends defn(`INSTALL_PKGS_FFMPEG',`INSTALL_PKGS_TRANSFORM360',`INSTALL_PKGS_GST',`INSTALL_PKGS_NGINX',`INSTALL_PKGS_GST_PLUGIN_VAAPI',`INSTALL_PKGS_GST_PLUGIN_BASE', `INSTALL_PKGS_GST_PLUGIN_GOOD', `INSTALL_PKGS_PYTHON', `INSTALL_PKGS_VA_GST_PLUGINS',`INSTALL_PKGS_OPENCL',`INSTALL_PKGS_LIBVA',`INSTALL_PKGS_OPENVINO')ifelse(index(DOCKER_IMAGE,dev),-1,\,vim\)
