...
RUN ifdef(`INSTALL_PKGS_FFMPEG',yum install -y epel-release; yum localinstall -y --nogpgcheck https://download1.rpmfusion.org/free/el/rpmfusion-free-release-7.noarch.rpm; ) \
...
ifdef(`INSTALL_PKGS_FFMPEG',`dnl
    yum remove -y -q epel-release rpmfusion-free-release; \
')dnl
