...
## Supported tags and respective Dockerfile links
 - [sg1-ubuntu-1804-media-ffmpeg-vmaf](https://github.com/OpenVisualCloud/Dockerfiles/blob/v21.6/SG1/ubuntu-18.04/media/ffmpeg-vmaf/Dockerfile)

## Quick reference
- #### Supported platform and OS
  Intel&reg; SG1 platform, Ubuntu 18.04
