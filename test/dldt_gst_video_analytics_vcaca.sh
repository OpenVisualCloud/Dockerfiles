...
gst-launch-1.0 -v filesrc location=test.ts ! decodebin ! video/x-raw ! videoconvert ! \
  gvadetect model=vehicle-license-plate-detection-barrier-0106.xml model-proc=dlstreamer-1.5.3/samples/model_proc/intel/object_detection/vehicle-license-plate-detection-barrier-0106.json device=HDDL ! queue ! \
  gvaclassify model=vehicle-attributes-recognition-barrier-0039.xml object-class=vehicle model-proc=dlstreamer-1.5.3/samples/model_proc/intel/object_attribute_estimation/vehicle-attributes-recognition-barrier-0039.json device=HDDL ! queue ! \
  gvaclassify model=license-plate-recognition-barrier-0001.xml object-class=license-plate model-proc=dlstreamer-1.5.3/samples/model_proc/intel/optical_character_recognition/license-plate-recognition-barrier-0001.json device=HDDL ! queue ! \
