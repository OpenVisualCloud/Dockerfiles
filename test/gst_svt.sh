...
gst-launch-1.0 -v filesrc location=test.yuv ! videoparse format=i420 width=320 height=240 framerate=30 ! svtvp9enc ! matroskamux ! filesink location=test.mkv
gst-launch-1.0 -v filesrc location=test.mkv ! decodebin ! filesink location=test.xx

#gst-launch-1.0 -v filesrc location=test.yuv ! videoparse format=i420 width=320 height=240 framerate=30 ! svtav1enc ! matroskamux ! filesink location=test.mkv
#gst-launch-1.0 -v filesrc location=test.mkv ! decodebin ! filesink location=test.xx
