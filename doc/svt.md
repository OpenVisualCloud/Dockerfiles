...
|------|------|------|
|SVT-HEVC|v1.4.2|HEVC-compliant encoder library core that achieves excellent density-quality tradeoffs|
|SVT-AV1|v0.7.5|AV1 Compliant encoder library for VOD and Live encoding / transcoding video applications|
