...
license_subs = {
                ...
                "gst-plugins-base" : ["|gst plugin base|GNU Lesser General Public License v2.1 or later|"],
                "owt-gst-base" : ["|gst plugin base|GNU Lesser General Public License v2.1 or later|"],
                "gst-plugins-bad" : ["|gst plugin bad|GNU Lesser General Public License v2.1 or later|"],
                "owt-gst-bad" : ["|gst plugin bad|GNU Lesser General Public License v2.1 or later|"],
                "gst-plugins-good" : ["|gst plugin good|GNU Lesser General Public License v2.1 or later|"],
                "owt-gst-good" : ["|gst plugin good|GNU Lesser General Public License v2.1 or later|"],
                "gst-libav" : ["|gst plugin libav|GNU Library General Public License Version 2.1 or later|"],
                "gst-python" : ["|gst python|GNU Library General Public License Version 2.1|"],
                "gst-svt" : ["|gst plugin svt|GNU Lesser General Public License v2.1 or later|"],
                "gst-plugins-ugly" : ["|gst plugin ugly|GNU Lesser General Public License v2.1 or later|"],
                "owt-gst-ugly" : ["|gst plugin ugly|GNU Lesser General Public License v2.1 or later|"],
                "gst-vaapi" : ["|gst plugin vaapi|GNU Lesser General Public License v2.1 or later|"],
                "gst-gva" : ["|gst plugin gva|MIT License|"],
                "owt-gst-gva" : ["|gst plugin gva|MIT License|"],
                ...
                "libpahomqtt" : ["|Eclipse Paho C Client Library for the MQTT Protocol|Eclipse Public License - v 2.0|"],
                ...
                "nginx-flv" : ["|NGINX_HTTP_FLV|BSD 2-clause \"Simplified\" License|"],
                "nginx" : ["|NGINX|BSD 2-clause \"Simplified\" License|"],
                "qat-nginx" : ["|asynch_mode_nginx |BSD 3-clause \"New\" or \"Revised\" License|"],
